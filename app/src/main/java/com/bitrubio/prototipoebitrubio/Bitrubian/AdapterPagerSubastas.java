...
public class AdapterPagerSubastas extends FragmentStatePagerAdapter {
    ...
    public AdapterPagerSubastas(FragmentManager fragmentManager) {
        super(fragmentManager);
    }

    public AdapterPagerSubastas(FragmentManager fm, CharSequence[] titles_tab, int num_tabs) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        switch (position){
            case 0:
                return new Tab_regSubastas();
            case 1:
                return new Tab_misSubastas();
            default:
                return null;
        }
    }
