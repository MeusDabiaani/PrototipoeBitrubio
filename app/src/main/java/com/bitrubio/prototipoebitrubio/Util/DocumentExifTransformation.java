...
/**
 * rota las imagenes en picasso
 * Picasso.with(getActivity()).load(uri).transform(new DocumentExifTransformation(getActivity(),uri)).resize(90,90).centerCrop().into(_image_foto);
 */
