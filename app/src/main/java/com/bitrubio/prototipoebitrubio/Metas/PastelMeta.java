 ...
 */
public class PastelMeta extends Fragment implements HorizontalPicker.OnItemSelected , HorizontalPicker.OnItemClicked{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_pastel_meta, container, false);
        ...
        buttons.setOnClickListener(new SegmentedButton.OnClickListenerSegmentedButton() {
            ...
            public void onClick(int index) {
                if (index == 0) {
                    Toast.makeText(getActivity(), "pieza", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(getActivity(), "paquete", Toast.LENGTH_SHORT).show();
                }
            }
        });
