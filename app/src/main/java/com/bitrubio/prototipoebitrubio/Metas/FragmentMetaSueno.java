 ...
 */
public class FragmentMetaSueno extends Fragment implements View.OnClickListener{
    int varSeleccion ;
    LinearLayout lnrObjetivo , lnrTiempo , lnrReta, lnrRedApoyo, lnrPrivacidad;
    FragmentTransaction FT;
    Toolbar toolbar;
    Typeface tf;
    public static FragmentMetaSueno newInstance (Bundle args){
        FragmentMetaSueno fragment = new FragmentMetaSueno();
        if (args != null){
            fragment.setArguments(args);
        }
        return fragment;
    }
    public FragmentMetaSueno() { }
