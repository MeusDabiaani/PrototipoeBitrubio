 ...
 */
public class BeberMeta extends Fragment implements HorizontalPicker.OnItemSelected , HorizontalPicker.OnItemClicked {
    String TAG = getClass().getName();
    Typeface tf;
    int varSeleccion;
    ImageButton imgButton;
    FragmentTransaction FT;
    public static BeberMeta newInstance (Bundle arguments){
        BeberMeta fragment = new BeberMeta();
        if (arguments != null){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =  inflater.inflate(R.layout.fragment_beber,container,false);
        ...
        buttons.addButtons(
                getString(R.string.copa),
                getString(R.string.latas));
        ...
        buttons.setOnClickListener(new SegmentedButton.OnClickListenerSegmentedButton() {
            ...
            public void onClick(int index) {
                if (index == 0) {
                    Toast.makeText(getActivity(), "copa", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(getActivity(), "latas", Toast.LENGTH_SHORT).show();
                }
            }
        });
